...
/*  This file has been modified by Uday Soni to implement TexttoSpeech
*   Module which can be activated on Touch of surface.
 */
...
public class CameraConnectionFragment extends Fragment implements  TextToSpeech.OnInitListener {
  ...
  //Speakout method for TTS
  public void speakOut() {

    //String[] list = {"one","two","one","two","one","two"};
    // List<Classifier.Recognition> results;
//    results = RecognitionScoreView.results;
//
    String text;
//    if (results != null) {
...
//    }
    ...
    text = RecognitionScoreView.text;
  ...
  public View onCreateView(
    ...
    v.setOnTouchListener(new View.OnTouchListener() {
      ...
      //OnTouch TextToSpeech code......
      @Override
      public boolean onTouch(View view, MotionEvent motionEvent) {
        Log.d("udayhjjjjjjjjjjj++++" , "Clicked"); //Just checking if method is called or not.
 ...
 //   b.setOnClickListener(new View.OnClickListener() {
  ...
  //      speakOut();
  //      Toast toast = Toast.makeText(getActivity(), "Speaking.", Toast.LENGTH_SHORT);
 //       toast.show();
  //   }
  // });
    return v;
